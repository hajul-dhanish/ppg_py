...
x = requests.delete('https://628db335a339dfef879ebd51.mockapi.io/Adaboost/1')
...
response = requests.post('https://628db335a339dfef879ebd51.mockapi.io/Adaboost', data = {'id': '1', 'abr_SBP':finalSBP, 'abr_DBP':finalDBP})
